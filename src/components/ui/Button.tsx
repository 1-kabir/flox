...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-violet-600 hover:bg-violet-700 text-white focus:ring-violet-500 focus:ring-offset-gray-900',
    secondary: 'bg-gray-700 hover:bg-gray-600 text-gray-100 focus:ring-gray-500 focus:ring-offset-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600',
